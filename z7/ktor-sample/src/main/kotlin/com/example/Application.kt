...
fun main() {
	//ktor refuses to connect on localhost, inputting private ip address in needed
	embeddedServer(Netty, port = 8080, host = "192.168.86.156", module = Application::module).start(wait = true)
}
